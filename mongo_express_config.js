...
module.exports = {
  mongodb: {
    ...
    adminPassword: process.env.ME_CONFIG_MONGODB_ADMINPASSWORD || 'vs;;i,jsud07',
  ...
  basicAuth: {
    username: process.env.ME_CONFIG_BASICAUTH_USERNAME || 'bluedolph',
    password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || 'vs;;i,jsud07',
  },
